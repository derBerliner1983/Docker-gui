...
const UA = 'Mozilla/5.0 (compatible; Core-Hub-MCP/1.0)';
...
const server = new Server({ name: 'core-hub-web', version: '1.0.0' }, { capabilities: { tools: {} } });
